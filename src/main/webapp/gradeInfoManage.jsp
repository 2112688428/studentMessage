...
<body style="margin: 5px;">
	<table id="dg" title="权限级别信息" class="easyui-datagrid" fitColumns="true"
	 pagination="true" rownumbers="true" url="gradeList" fit="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="gradeName" width="100">权限级别名称</th>
				<th field="gradeDesc" width="250">权限描述</th>
			</tr>
		</thead>
	</table>
	...
	<div id="tb">
		...
		<div>&nbsp;权限名称：&nbsp;<input type="text" name="s_gradeName" id="s_gradeName"/><a href="javascript:searchGrade()" class="easyui-linkbutton" iconCls="icon-search" plain="true">搜索</a></div>
	</div>
