...
<body style="margin: 5px;">
	 ...
	 pagination="true" rownumbers="true" url="studentList" fit="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="stuNo" width="100" align="center">用户id</th>
				...
				<th field="gradeId" width="100" align="center" hidden="true">权限级别ID</th>
				<th field="gradeName" width="100" align="center">权限名称</th>
	...
	<div id="tb">
		...
		<div>&nbsp;用户id：&nbsp;<input type="text" name="s_stuNo" id="s_stuNo" size="10"/>
		...
		&nbsp;所属权限：&nbsp;<input class="easyui-combobox" id="s_gradeId" name="s_gradeId" size="10" data-options="panelHeight:'auto',editable:false,valueField:'id',textField:'gradeName',url:'gradeComboList'"/>
